...
class SpecialFileField(FileField):
    ...
    def __init__(self,*args,**kwargs):
        ...
        super(SpecialFileField,self).__init__(*args,**kwargs)
    
    def clean(self,*args,**kwargs):
        
        data = super(SpecialFileField,self).clean(*args,**kwargs)
        
        # Getting Uploaded file data into file variable
        file = data.file
        ...
        try:
            ...
            if my_content_type in self.content_types:
                ...
                if file_size < self.max_upload_size:
                    ...
                    raise forms.ValidationError(("Please Upload File Under %s.Current FileSize is %s") %(filesizeformat(self.max_upload_size),
                                                                                                        filesizeformat(file_size)))

            else:
                raise forms.ValidationError(("Unsupported File Types.Please Upload Video File of type mp4 and mkv"))
